...
The class uses the \file{natbib} package for formatting references.
...
If your bibliography is chapterwise, you may set a \verb!sectionbib! option to \verb~documentclass~,
and remove \verb~\include{references}~ at the end of the \verb~book.tex~ file.
Bibtex users may substitute \verb~\include{references}~ with \verb~\bibliographystyle{<bibstyle>}~ and\\ \verb~\bibliography{<bibdata-file>}~.
